...
<head>
    ...
    <title>Finding Teacher - Reset</title>
    ...
    <section id="services" style="margin-top:-50px;">
        ...
        <div class="container">
            <div class="row">
                ...
                echo form_open('main/reset_password', $attributes);
                ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-8 pull-right">
                            <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-fw fa-paper-plane"></i> Reset</button>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
