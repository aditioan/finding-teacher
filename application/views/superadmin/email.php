        ...
        <section class="content">
          <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Email New Message</h3>
            </div>
            <div class="box-body">
              <?php
                  $attributes = array('class' => 'form-validation broadcast', 'role' => 'form');

                  echo form_open('superadmin/send_email', $attributes);
              ?>
              <div class="form-group">
                <input class="form-control" placeholder="Email:" value="<?php echo $email; ?>" name="email">
              </div>
              <div class="form-group">
