...
<html>
  ...
  <body class="hold-transition skin-red-light sidebar-mini">
          ...
          <div class="box box-danger">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                  <button type="button" class="btn btn-warning btn-flat" data-toggle="modal" data-target="#tambahMurid"><i class="fa fa-plus"></i> Tambah Murid</button>
                </div>
            </div>
            <div class="box-body">
              <table class="table table-bordered table-hover datatable">
                ...
                <tbody>
                <?php $no = 1; ?>
                <?php foreach ($data_murid as $key => $item):?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo site_url('superadmin/detail-murid').'/'.$item->id_user ?>" class="btn btn-info btn-xs btn-detail-user btn-flat btn-block"><i class="fa fa-fw fa-arrow-right"></i> Detail</a>
    ...
    <div class="modal fade" id="tambahMurid" tabindex="-1" role="dialog" aria-labelledby="myTambahMurid" aria-hidden="true"> 
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-yellow text-center">
                    <h4 class="modal-title" id="myTambahMurid">Tambah Murid</h4>
                </div>
                <?php
    ...
    <script type="text/javascript">
      ...
      $(document).on('click', '.btn-delete-user', function () {
        ...
        bootbox.dialog({
          message: "Apakah anda yakin akan menghapus data Murid <strong>"+name+"</strong> ? <br /> Data yang dihapus tidak akan bisa dikembalikan, lebih aman untuk mem <strong>Blok</strong> data.",
          title: "Konfirmasi",
          buttons: {
            main: {
              label: "Tidak",
      ...
      $(document).on('click', '.btn-mail', function () {
        ...
        var email = $(this).data('email');
        bootbox.dialog({
          message: "Apakah anda yakin akan mengirim pesan ke murid ini?",
          title: "Konfirmasi",
          buttons: {
            main: {
              label: "Tidak",
