  ...
  <body class="hold-transition skin-red sidebar-mini">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  echo form_open('murid/set_pesan', $attributes);
                  ?>
                      <div id="pesan">
                      </div>
                      <div id="data">
                      ...
                      <div class="form-group">
                          <div class="col-sm-4">
                            <i class="fa fa-user"></i> <strong>Nama Guru <span style="color:#EC644B;">*</span></strong>
                          </div>
                          <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          ...
                          <select class="validate[required] form-control" name="lokasi_kursus" id="lokasi_kursus">
                              <?php foreach ($lokasi_mengajar as $key => $item): ?>
                                  <?php if($kecamatan == $item->kecamatan_mengajar): ?>
                                    <option value="<?php echo $item->kecamatan_mengajar ?>"><?php echo $item->district_name ?></option>
                                  <?php endif ?>
                              <?php endforeach ?>
                          </select>
    ...
    <script type="text/javascript">
      ...
      $('#hari_kursus').on('change', function() {
          ...
          $.get("<?php echo site_url('murid/jam_kursus/"+hari_kursus+"') ?>")
