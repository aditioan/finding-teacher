...
<header class="main-header">
  ...
  <!-- Logo -->
  <a href="<?php echo site_url('murid') ?>" class="logo">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><b>Murid</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Murid</b></span>
  </a>
        ...
        <li class="dropdown user user-menu">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php if ($this->session->userdata('photo_profil') == ''): ?>
              <img src="<?php echo img_url('avatar.png') ?>" class="user-image" alt="User Image">
            <?php else: ?>
              <img src="<?php echo base_url('uploads/murid/profil').'/'.$this->session->userdata('photo_profil') ?>" style="width:20px;height:20px" class="img-circle" alt="User Image">
            <?php endif ?>
