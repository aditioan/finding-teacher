...
echo form_open_multipart('guru/data_profil', $attributes);
?>
<div class="form-group">
  <h3 class="col-sm-4 control-label">Profil Guru</h3>
</div>
<div class="form-group">
    <div class="col-sm-7 col-sm-offset-4">
        ...
        <?php else: ?>
            <img src="<?php echo base_url('uploads/guru/profil').'/'.$this->session->userdata('photo_profil') ?>" style="width:225px;height:300px;border-radius:10px;" alt="User Image">
        <?php endif ?>
        <p>* Masukkan gambar berformat JPG/PNG dengan perbandingan<br />resolusi 3x4 dan besar maksimal 2 MB</p>
