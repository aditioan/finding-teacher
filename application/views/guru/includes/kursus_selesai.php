...
<div class="form-group">
    <label for="kursus" class="col-sm-2 control-label">Kursus yang selesai </label>
      ...
      <table class="wrap table table-bordered table-hover data-kursus">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="<?php echo site_url('guru/detail-kursus').'/'.$item->id_kursus ?>" class="btn btn-flat btn-info btn-sm btn-block btn-detail-kursus"><i class="fa fa-fw fa-arrow-right"></i> Detail</a></td>
          </tr>
          <?php $no++; ?>
          <?php endif ?>
          <?php endforeach ?>
