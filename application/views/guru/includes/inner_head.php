...
-->
<link rel="stylesheet" href="<?php echo css_url('skin-red.min.css'); ?>">
...
<link href="<?php echo css_url('datatables.min.css'); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo css_url('datepicker3.css'); ?>" rel="stylesheet" type="text/css">