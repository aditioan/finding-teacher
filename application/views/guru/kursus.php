  ...
  <body class="hold-transition skin-red sidebar-mini">
    ...
    <script type="text/javascript">
      ...
      $(document).on('click', '.btn-terima', function () {
        ...
        bootbox.dialog({
          message: "Apakah anda yakin akan menerima pesanan kursus <strong>"+name+"</strong> ?",
          title: "Konfirmasi",
          buttons: {
            main: {
              label: "Tidak",
            ...
            danger: {
              ...
              callback: function(result) {
                if (result) {
                  ...
                  window.location.replace("<?php echo site_url('guru/terima_pesanan/"+id+"');?>");
                }
              }
            }
          }
      ...
      $(document).on('click', '.btn-tolak', function () {
        ...
        var name = $(this).data('nama');
        bootbox.dialog({
          message: "Apakah anda yakin akan menolak pesanan kursus <strong>"+name+"</strong> ?",
          title: "Konfirmasi",
          buttons: {
            main: {
              label: "Tidak",
            ...
            danger: {
              ...
              callback: function(result) {
                if (result) {
                  $this.html('<i class="fa fa-fw fa-spin fa-spinner"></i>');
                  window.location.replace("<?php echo site_url('guru/tolak_pesanan/"+id+"');?>");
                }
              }
            }
          }
      ...
      $(document).on('click', '.btn-selesai', function () {
        ...
        var name = $(this).data('nama');
        bootbox.dialog({
          message: "Apakah anda yakin akan mengakhiri kursus <strong>"+name+"</strong> ?",
          title: "Konfirmasi",
          buttons: {
            main: {
              label: "Tidak",
            ...
            danger: {
              ...
              callback: function(result) {
                if (result) {
                  $this.html('<i class="fa fa-fw fa-spin fa-spinner"></i>');
                  window.location.replace("<?php echo site_url('guru/akhiri_pesanan/"+id+"');?>");
                }
              }
            }
          }
          ...
          buttons: {
            ...
            danger: {
              ...
              callback: function(result) {
                if (result) {
                  $this.html('<i class="fa fa-fw fa-spin fa-spinner"></i>');
                  window.location.replace("<?php echo site_url('guru/delete_pesanan_kursus/"+id+"');?>");
                }
              }
            }
          }
