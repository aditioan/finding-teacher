...
<body id="page-top">
    ...
    <section id="services" style="margin-top:-50px;">
        ...
        <div class="container">
            <div class="row">
                <?php if (empty($hasil)): ?>
                    <h3 class="text-center">Data pencarian tidak ditemukan!</h3>
                <?php else: ?>
                    <?php $no = 1; ?>
                    <?php foreach ($hasil as $key => $item): ?>
                        <div class="col-lg-8 col-md-10 col-md-offset-2">
                            <!-- <button type="button" class="btn btn-danger btn-flat pull-right btn-pesan">Pilih</button> -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <br>
                                    <div class="centered">
                                        <a href="<?php echo site_url('detail').'/'.$item->id_user.'/'.$item->id_mapel ?>" class="btn btn-warning btn-flat">Detail</a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <table id="data-search" class="wrap table table-hover">
                                        ...
                                        <tr>
                                            <td width="30%"><i class="fa fa-calendar"></i> Jam /Pertemuan</td>
